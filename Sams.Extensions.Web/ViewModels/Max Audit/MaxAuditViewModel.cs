...
namespace Sams.Extensions.Web
{
    public static class FsaConstants
    {
        ...
        public static List<SelectListItem> Locations
        {
            get
            {
            ...
            {
                    new SelectListItem { Text = "North", Value = "206" },
                new SelectListItem { Text = "East", Value = "207" },
                new SelectListItem { Text = "West", Value = "215" },
                
                new SelectListItem { Text = "South", Value = "214" }
            };
        ...
        public static FsaViewModel DefaultInstance
        {
            get
            {
                ...
                return new FsaViewModel
                {
                    ...
                    Locations = FsaConstants.Locations,
